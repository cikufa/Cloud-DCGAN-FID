...
noise= np.random.normal(0,0.01,(ebatch, latent_dim))
...
# g_model = tf.keras.models.load_model('final/model128/generator_030.h5')
# # exs = (g_model.predict(noise).reshape(ebatch,128,128,3) +1)/2
# exs, y_fake =u.generate_fake_samples(g_model, latent_dim, ebatch)
# u.save_plot(exs, 'tanavo.jpg', 3)
